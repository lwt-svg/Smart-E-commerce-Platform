...
from apps.order.views import OrderDetailGenericAPIView, OrderGenericAPIView, OrderGoodsGenericAPIView,deleteOrderGoods
...
urlpatterns = [
    ...
    path("delete", deleteOrderGoods.as_view()),
]